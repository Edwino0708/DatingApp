...
namespace DatingApp.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetMessage(int userId, int id)
        {
            ...
            var meesageFromRepo = await _repo.GetMessage(id);

            if (meesageFromRepo == null)
                return NotFound();

            return Ok(meesageFromRepo);
        ...
        public async Task<IActionResult> GetMessagesForUser(int userId, [FromQuery] MessageParams messageParams)
        {
            ...
            Response.AddPagination(messagesFromRepo.CurrentPage, messageParams.PageSize, messagesFromRepo.TotalCount, messagesFromRepo.TotalPages);
